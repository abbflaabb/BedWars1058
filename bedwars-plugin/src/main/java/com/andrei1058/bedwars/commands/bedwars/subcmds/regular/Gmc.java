...
public class Gmc extends SubCommand {
    public Gmc(ParentCommand parent, String name) {
        super(parent, name);
        this.showInList(true);
        this.setDisplayInfo(MainCommand.createTC("§6 ▪ §7/" + MainCommand.getInstance().getName() + " gmc", "/" + this.getParent().getName() + " " + this.getSubCommandName(), "§fSwitch to Creative mode.\n§eClick to activate"));
    }
